...
export const ecoWelshTemplate = (riding?: boolean): string => {
  return `
{{#if showEcoText}}
# ${riding ? 'Marchogaeth' : 'Mae gyrru'} tanwydd-effeithlon

{{#if (displayEcoExplanation category)}}
${riding ? 'Marchogaeth' : 'Mae gyrru'} tanwydd-effeithlon o ran tanwydd yn arddull o yrru diogel sy'n lleihau eich defnydd o danwydd ac yn helpu'r amgylchedd.
{{/if}}
