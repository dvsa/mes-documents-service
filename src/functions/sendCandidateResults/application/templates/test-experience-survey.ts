...
# Eich profiad o’r prawf
Beth bynnag y canlyniad, hoffem gael adborth am eich profiad o'r prawf. Cwblhewch yr arolwg gwirfoddol byr hwn, hyd yn oed os ydych wedi gwneud hynny o'r blaen, gan ein bod am ddeall eich profiad o'r prawf diweddaraf.
https://www.smartsurvey.co.uk/s/eichprawfgyrru
`;
...
export const testExperienceRidingSurveyTemplate = `
# Your experience of the driving test
However your test went, we’d really like your feedback about your experience of the driving test. Please complete this short survey, it should only take about 5 minutes. The survey is voluntary.
https://www.smartsurvey.co.uk/s/RiderCandidateCSAT/
`;
