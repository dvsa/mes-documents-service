...
Before you take your ADI Part 2 test again, make sure to:

1. Practice the areas of the ADI Part 2 test you failed on this time. Consider taking more lessons and read the Highway Code at https://www.gov.uk/guidance/the-highway-code.
2. DVSA strongly recommends that you seek further development from an ORDIT (Official Register of Driving Instructor Trainers) registered trainer. You can find ORDIT driving instructor training courses at https://www.gov.uk/find-driving-instructor-training
3. Book your ADI Part 2 test at least 10 working days away at https://www.gov.uk/book-driving-test or by calling 0300 200 1122.

#How to appeal your ADI Part 2 test

You can appeal if you think your examiner did not follow the regulations when they carried out your test. Find out how to appeal at https://www.gov.uk/adi-part-2-test/faults-test-result. Your test result cannot be changed, but you might get a free retest if your appeal is successful. You might need to pay court costs if your appeal does not succeed.
